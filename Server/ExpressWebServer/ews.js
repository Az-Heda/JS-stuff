...
class CallbackNotValid extends Error {
	 ...
	 * @throws {CallbackNotValid} Callback is not valid
	 */
	constructor(message) {
		super();
...
class PathNotValid extends Error {
	 ...
	 * @description Throw an Error that means you miss some function parameters
	 * @param {string} message Error message to show
	 * @throws {PathNotValid} The given path is not valid
	 */
	constructor(message) {
		super();
		this.name = this.constructor.name;
...
class NotExistingSubdomains extends Error {
	 ...
	 * @description Throw an Error that means you miss some function parameters
	 * @param {string} message Error message to show
	 * @throws {NotExistingSubdomains} Trying to access in a not-existing subdomains
	 */
	constructor(message) {
		super();
		this.name = this.constructor.name;
...
class MissingParameters extends Error {
	 ...
	 * @description Throw an Error that means you miss some function parameters
	 * @param {string} message Error message to show
	 * @throws {MissingParameters} A required parameters is missing
	 */
	constructor(message) {
		super();
		this.name = this.constructor.name;
...
class SocketError extends Error {
	 ...
	 * @description Throw an Error that means you miss some function parameters
	 * @param {string} message Error message to show
	 * @throws {SocketError} General socket error
	 */
	constructor(message) {
		super();
		this.name = this.constructor.name;
...
class UnknownError extends Error {
	 ...
	 * @description Throw an Error that means you miss some function parameters
	 * @param {string} message Error message to show
	 * @throws {UnknownError} A general unexpected error
	 */
	constructor(message) {
		super();
		this.name = this.constructor.name;
